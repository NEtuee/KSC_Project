...
{
	[MenuItem("Assets/Create/GraphProcessor/Node C# Script", false, MenuItemPosition.afterCreateScript)]
	private static void CreateNodeCSharpScritpt() => CreateDefaultNodeCSharpScritpt();
	
	[MenuItem("Assets/Create/GraphProcessor/Node View C# Script", false, MenuItemPosition.afterCreateScript + 1)]
