...
public class RebindingUI : MonoBehaviour
{
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<RebindingUI, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<RebindingUI, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
