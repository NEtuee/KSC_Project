...
public class RopeEx : MonoBehaviour
{
    ...
    public void UpdatePosition()
    {
        ...
        for(int i = 1; i < joints.Count; ++i)
        {
            ...
            if(dist > max)
            {
                ...
                dir = dir.normalized;
                joints[i].position += dir * (dist - max);
                ...
                joints[i].velocity = Vector3.zero;
            }
        }
    ...
    public void Render()
    {
        ...
        {
            GizmoHelper.Instance.DrawCircle(j.position,ropeThickness,Color.red);
            GizmoHelper.Instance.DrawLine(j.position,j.position + j.velocity.normalized,Color.red);
        }
    }
}
