	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 panner33 = ( v.ase_texcoord.w * float2( 0,-0.2 ) + temp_output_29_0);
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord7 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner9 = ( IN.ase_texcoord4.z * float2( 0,0.02 ) + texCoord7);
				float2 texCoord22 = IN.ase_texcoord4.xy * float2( 1,0.2 ) + float2( 0,0 );
				float2 panner21 = ( 5.0 * _Time.y * float2( 0,0.035 ) + texCoord22);
				float2 temp_output_29_0 = ( texCoord30 + ( ( ( (tex2D( _T_BASE, panner9 )).rg * 0.4 ) + ( (tex2D( _T_flow, panner21 )).rg * 0.2 ) ) * _Dist ) );
				float2 panner33 = ( IN.ase_texcoord4.w * float2( 0,-0.2 ) + temp_output_29_0);
				float4 tex2DNode32 = tex2D( _T_line, panner33 );
				float4 _color_4_Instance = UNITY_ACCESS_INSTANCED_PROP(VFX_shield,_color_4);
				float4 temp_output_63_0 = ( ( IN.ase_color.r * tex2DNode32.r ) * _color_4_Instance );
				float4 fetchOpaqueVal106 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( ase_grabScreenPosNorm + temp_output_63_0 ).xy ), 1.0 );
				...
				float temp_output_47_0 = ( _color2_Instance.a * ( temp_output_37_0 * ( saturate( pow( fresnelNode40 , _Fresnel_POw ) ) * _Fresnel_brightness ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( fetchOpaqueVal106 + ( temp_output_63_0 + ( _color_Instance * temp_output_37_0 ) ) ).rgb;
				float Alpha = temp_output_47_0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner21 = ( 5.0 * _Time.y * float2( 0,0.035 ) + texCoord22);
				float2 temp_output_29_0 = ( texCoord30 + ( ( ( (tex2D( _T_BASE, panner9 )).rg * 0.4 ) + ( (tex2D( _T_flow, panner21 )).rg * 0.2 ) ) * _Dist ) );
				float2 panner33 = ( IN.ase_texcoord2.w * float2( 0,-0.2 ) + temp_output_29_0);
				float4 tex2DNode32 = tex2D( _T_line, panner33 );
				float2 panner34 = ( 1.0 * _Time.y * float2( 0,0.15 ) + temp_output_29_0);
				float temp_output_37_0 = ( tex2DNode32.r + tex2D( _T_flow02, panner34 ).r );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
...
/*ASEBEGIN
Version=18707
-36;35;1920;1815;904.7719;-261.989;1.3;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;23;-2283.462,306.243;Inherit;True;Property;_T_flow;T_flow;1;0;Create;True;0;0;False;0;False;None;4a746e0d470824a4f9d46e6634e55c13;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-1315.614,308.5021;Inherit;False;Property;_Dist;Dist;3;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;35;-755.8715,247.1514;Inherit;True;Property;_T_flow02;T_flow02;4;0;Create;True;0;0;False;0;False;None;4a746e0d470824a4f9d46e6634e55c13;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.PannerNode;33;-506.7773,76.28325;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,-0.2;False;1;FLOAT;5;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;31;-715.6672,-180.9925;Inherit;True;Property;_T_line;T_line;2;0;Create;True;0;0;False;0;False;None;4a01f35b24dc154439eb0660d8943e27;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-416,1040;Inherit;False;Property;_Fresnel;Fresnel;8;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-80,1040;Inherit;False;Property;_Fresnel_POw;Fresnel_POw;9;0;Create;True;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;192,1040;Inherit;False;Property;_Fresnel_brightness;Fresnel_brightness;10;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;1084.693,1133.16;Inherit;False;Property;_WPO;WPO;11;0;Create;True;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;55;723.8582,421.8338;Inherit;False;InstancedProperty;_color2;color2;7;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0.2196078;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;108;2216.977,-9.254517;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;62;364.2719,-235.3391;Inherit;False;InstancedProperty;_color_4;color_4;6;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0.2311321,0.499482,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GrabScreenPosition;105;1469.022,-595.9534;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;64;-214.5374,-563.565;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;111;-56.88762,649.2015;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;-1,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenColorNode;106;2079.738,-374.6547;Inherit;False;Global;_GrabScreen0;Grab Screen 0;12;0;Create;True;0;0;False;0;False;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;109;1492.996,141.6046;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;1771.408,381.1329;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;38;171.4049,-72.40497;Inherit;False;InstancedProperty;_color;color;5;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;20.1581,11.61174,5.800208,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;65;1143.552,-257.532;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;107;1873.878,-288.8799;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
