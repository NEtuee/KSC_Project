...
#define kDielectricSpec half4(_Specular, _Specular, _Specular, 1.0 - 0.04) // standard dielectric reflectivity coef at incident angle (= 4%)
...
//TODO:DOTS - we need to port probes to live in c# so we can manage this manually.
    ...
    return irradiance * occlusion * _EnvReflection;
