	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float4 texCoord12 = v.ase_texcoord;
				texCoord12.xy = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_11_0 = ( texCoord12.z * _TimeParameters.z );
				float2 texCoord30 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord7 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner9 = ( temp_output_11_0 * float2( 0,0.02 ) + texCoord7);
				float2 texCoord22 = v.ase_texcoord.xy * float2( 1,0.2 ) + float2( 0,0 );
				float2 panner21 = ( temp_output_11_0 * float2( 0,0.035 ) + texCoord22);
				float2 temp_output_29_0 = ( texCoord30 + ( ( ( (tex2Dlod( _T_BASE, float4( panner9, 0, 0.0) )).rg * 0.0 ) + ( (tex2Dlod( _T_flow, float4( panner21, 0, 0.0) )).rg * 0.0 ) ) * texCoord12.w ) );
				float2 panner33 = ( temp_output_11_0 * float2( 0,0.1 ) + temp_output_29_0);
				float4 tex2DNode32 = tex2Dlod( _T_line, float4( panner33, 0, 0.0) );
				float2 panner34 = ( temp_output_11_0 * float2( 0,0.15 ) + temp_output_29_0);
				float4 tex2DNode36 = tex2Dlod( _T_flow02, float4( panner34, 0, 0.0) );
				float temp_output_37_0 = ( tex2DNode32.r + tex2DNode36.r );
				...
				float3 temp_output_86_0 = ( v.ase_normal * ( ( temp_output_37_0 * _WPO ) + ( pow( ( clampResult79 - clampResult81 ) , 5.0 ) * tex2DNode36.r ) ) );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 texCoord12 = IN.ase_texcoord3;
				...
				float2 panner21 = ( temp_output_11_0 * float2( 0,0.035 ) + texCoord22);
				float2 temp_output_29_0 = ( texCoord30 + ( ( ( (tex2D( _T_BASE, panner9 )).rg * 0.0 ) + ( (tex2D( _T_flow, panner21 )).rg * 0.0 ) ) * texCoord12.w ) );
				float2 panner33 = ( temp_output_11_0 * float2( 0,0.1 ) + temp_output_29_0);
				...
				float temp_output_37_0 = ( tex2DNode32.r + tex2DNode36.r );
				float4 temp_output_65_0 = ( ( ( IN.ase_color.r * tex2DNode32.r ) * _color_4_Instance ) + ( _color_Instance * temp_output_37_0 ) );
				...
				float fresnelNode40 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV40, _Fresnel_POw ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_output_65_0.rgb;
				float Alpha = ( _color2_Instance.a * ( temp_output_37_0 * ( saturate( fresnelNode40 ) * _Fresnel_Intensity ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _color2_Instance = UNITY_ACCESS_INSTANCED_PROP(VFX_shield,_color2);
				float4 texCoord12 = IN.ase_texcoord2;
...
/*ASEBEGIN
Version=18707
61;660;1443;894;-333.5576;-840.3396;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;13;-3291.874,-67.76962;Inherit;False;360;405;Speed(w)/ dist(t);1;12;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;